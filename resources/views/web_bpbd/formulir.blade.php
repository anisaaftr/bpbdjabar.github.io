...
<center>
    <h3 class="mt-5">PERNYATAAN KEBERATAN ATAS PERMOHONAN INFORMASI</h3>
...
<div class="card col-sm-7">
    ...
    <div class="card-body">
        <form action="/formulir-keberatan/tambah" method="post" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="qUuc52Ris7bZlHH7hfQG7Q0uHtO3PtIG9Yc4aGXN">
            <h6><b>A. INFORMASI PENGAJU KEBERATAN</b></h6>
            <div class="form-group mt-3">
                <label>Nomor Regsitrasi Keberatan</label>
                <div class="input-group">
                    <input type="no_registrasi" name="no_registrasi" value="" placeholder="" autocomplete='off' class="form-control" required>
                </div>
            </div>
            <div class="form-group mt-3">
                <label>No Pendaftaran Permohonan Informasi</label>
                <div class="input-group">
                    <input type="text" name="no_pendaftaran" value="" placeholder="" autocomplete='off' class="form-control" required>
                </div>
            </div>
            <div class="form-group mt-3">
                ...
                <div class="form-group mt-3">
                    ...
                    <div class="input-group">
                        <input type="text" value="" placeholder="" 
                            name="nama" autocomplete='off' class="form-control" required>
                    </div>
                </div>
                <div class="form-group mt-3">
                    <label>Alamat</label>
                    <div class="input-group">
                        <input type="text" value="" placeholder="" 
                            name="alamat" autocomplete='off' class="form-control" required>
                    </div>
                </div>
                <div class="form-group mt-3">
                    ...
                    <div class="input-group">
                        <input type="text" value="" placeholder="" 
                            name="pekerjaan" autocomplete='off' class="form-control" required>
                    </div>
                </div>
                <div class="form-group mt-3">
                    ...
                    <div class="input-group">
                        <input type="text" value="" placeholder="" 
                            name="no_telp" autocomplete='off' class="form-control" required>
                    </div>
                </div>
            </ul>
            <br>
            ...
            <h6><b>B. ALASAN PENGAJUAN KEBERATAN</b></h6>
            <input type="radio" name="alasan_pengajuan"
                    value="Permohonan Informasi di tolak">
                    &nbsp; Permohonan Informasi di tolak <br>
            <input type="radio" name="alasan_pengajuan"
                    value="Informasi berkala tidak disediakan">
                    &nbsp; Informasi berkala tidak disediakan <br>
            <input type="radio" name="alasan_pengajuan"
                    value="Permintaan informasi tidak ditanggapi">
                    &nbsp; Permintaan informasi tidak ditanggapi<br>
            <input type="radio" name="alasan_pengajuan"
                    value="Permintaan informasi ditanggapi tidak sebagaimana yang diminta">
                    &nbsp; Permintaan informasi ditanggapi tidak sebagaimana yang diminta<br>
            <input type="radio" name="alasan_pengajuan"
                    value="Permintaan informasi tidak dipenuhi">
                    &nbsp; Permintaan informasi tidak dipenuhi<br>
            <input type="radio" name="alasan_pengajuan"
                    value="Biaya yang dikenakan tidak wajar">
                    &nbsp; Biaya yang dikenakan tidak wajar<br>
            <input type="radio" name="alasan_pengajuan"
                    value="Informasi disampaikan melebihi jangka waktu yang ditentukan">
                    &nbsp; Informasi disampaikan melebihi jangka waktu yang ditentukan<br><br>
            
            
            
            <h6><b>C. KASUS POSISI (Tambahkan Kertas Bila Perlu)</b></h6>
            <div class="form-group mt-3">
                <div class="input-group">
                    <textarea value="" placeholder="" name="kasus_posisi"
                        autocomplate='off' class="form-control"
                        required rows="3"></textarea>
                </div>
            </div>
            <h6><b>D. HARI / TANGGAL TANGGAPAN ATAS KEBERATAN AKAN DIBERIKAN</b></h6>
            <div class="form-group mt-3">
                <div class="input-group">
