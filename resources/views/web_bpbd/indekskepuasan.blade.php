...
<div class="container penjabat mt-5">
    <header class="section-header">INDEKS KEPUASAN MASYARAKAT</header>

    <div class="row mt-3">
        <img src="{{asset('bpbds/indeks-kepuasan.png')}}" alt="Indeks Kepuasan Masyarakat" style="width:100%;" class="rounded">
    </div>
    ...
    <div class="card border-0">
        ...
        <P>Indeks Kepuasan Masyarakat (IKM) adalah data dan informasi tentang tingkat
            ...
            IKM Dinas Pendidikan Provinsi Jawa Barat menunjukan tingkat
            kinerja pelayanan publik yang telah diselenggarakan.
        </P>
        <p>&nbsp;</p>
    </div>
</div>
<br>
<br>
<!-- Akhir indeks kepuasan masyarakat-->
