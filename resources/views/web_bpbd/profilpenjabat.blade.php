...
<div class="container penjabat mt-5">
    <header class="section-header">PROFIL PENJABAT</header>

    <div class="row">
        <img src="{{asset('bpbds/profil-penjabat.jpg')}}" alt="Profil Penjabat" style="width:100%;" class="rounded mt-4">
    </div>
</div>
<br>
<br>
<!-- Akhir Profil Penjabat -->
