...
<div class="container vm mt-5">
    <header class="section-header">VISI DAN MISI</header>

    <div class="card border-0 mt-3">
        <p><b class="head">Visi</b></p>
        <p>Terwujudnya Jawa Barat juara lahir dan batin dengan inovasi dan kolaborasi.</p>

        <p><b class="head">Misi Organisasi</b></p>
        <ol>
            <li>Membentuk manusia pancasila yang bertaqwa melalui peningkatan peran masjid dan tempat ibadah sebagai pusat peradaban.</li>
            <li>Melahirkan manusia yang berbudaya, berkualitas, bahagia, dan produktif melalui peningkatan pelayanan public yang inovatif.</li>
            <li>Mempercepat pertumbuhan dan pemerataan pembangunan berbasis lingkungan dan tata ruang yang berkelanjutan melalui peningkatan konektivitas wilayah dan penataan daerah.</li>
            <li>Meningkatkan produktivitas dan daya saing usaha ekonomi umat yang sejahtera dan adil melalui pemanfaatan teknologi digital dan kolaborasi dengan pusat-pusat inovasi serta pelaku pembangunan.</li>
            <li>Mewujudkan tata kelola pemerintah yang inovatif dan kepemimpinan yang kolaboratif antara Pemerintah Pusat, Provinsi, dan Kabupaten/Kota.</li>
        </ol>
    </div>
