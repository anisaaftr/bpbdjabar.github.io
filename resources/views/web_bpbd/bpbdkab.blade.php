...
<div class="container penjabat mt-5">
    <header class="section-header">BPBD KAB/KOTA JAWA BARAT</header>

    <div class="row mt-3">
        <div class="col">
            <div class="container-fulid p-0 mb-5 wow fadeIn" data-wow-delat="0.1s">
                <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{asset('bpbds/bpbdkab-kota.png')}}" alt="Image" class="w-100">
                            <br><br><br>

                            <center>
                                <h6>
                                    <b>Dasar Hukum : </b>11111 <br>
                                    <b>Pusat Pemerintahan : </b>22222 <br>
                                    <b>Alamat : </b>33333 <br>
                                    <b>Telepon : </b>44444 <br>
                                    <b>Email : </b>55555 <br><br><br>
                                    <a href="66666" class="btn bg-light p-2 col-2 text-dark" target="_blank"
                                        style="border-radius:20px; box-shadow:0px 5px 15px rgba(0,0,0,0.185);">
                                        Kunjungi Website
                                    </a>
                                </h6>
                            </center>
                        ...
                        <div class="carousel-control-prev text-dark" type="button" data-bs-target="#header-carousel1" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" style="color:black;" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </div>
                        <div class="carousel-control-next text-dark" type="button" data-bs-target="#header-carousel1" data-bs-slide="next">
